...
"
"      Created: 2011-03-15 17:17:16
"      Version: 0.0.2
"      History:
"               0.0.1 | dantezhu | 2011-03-15 17:17:16 | initialization
"               0.0.2 | dantezhu | 2012-01-16 18:45:23 | 解决同一行有多个颜色
"               不能正常显示的问题
"
"=============================================================================
...
"Add-Begin by dantezhu in 2012-01-16 18:40:55
   let line_str = getline(a:where)
   let i = 0
   while i < len(line_str)
       " code
       let foundcolor = matchstr(line_str, '#[0-9A-Fa-f]\{3,6\}\>', i)

       let i += len(foundcolor)
...
"Mod-Begin by dantezhu in 2011-03-15 17:17:07
...
"Del-Begin by dantezhu in 2011-03-15 17:17:00
